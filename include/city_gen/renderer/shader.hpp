...
public:
	...
	// const function as seen here will throw a compiler error if the function writes to a class member function. Reading is fine
	// essncially making all variables outside of that funtion const
